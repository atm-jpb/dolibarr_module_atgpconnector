...
/**
 * 	\file		core/triggers/interface_99_modMyodule_atgpconnectortrigger.class.php
 * 	\ingroup	atgpconnector
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modAtgpconnector_Mytrigger.class.php
 ...
 * Trigger class
 */
class Interfaceatgpconnectortrigger
{
    ...
    public function __construct($db)
    {
        ...
        $this->picto = 'atgpconnector@atgpconnector';
    }
